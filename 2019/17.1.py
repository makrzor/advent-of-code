    ...
    while instruction != 99:
        ...
        if instruction == 1:
            ...
            if param[0] == 10:
                ...
                output[line].append(chr(param[0]))
        elif instruction == 5:
            if param[0]:
...
for line in range(1, len(output) - 1):
    for x in range(1, len(output[line + 1]) - 1):
        if output[line - 1][x] == output[line][x - 1] == output[line][x]\
           == output[line][x + 1] == output[line + 1][x] == "#":
            alignment_sum += line * x
